...
> **v1.3.6** · Semantic diff and three-way merge for spreadsheet-based configuration data
...
- `test_merger.py`: 27 merge-engine cases covering 5 cell states, 10 row-level states, resolution validation, and XML write-back roundtrip
- `test_api_merge.py`: 15 API cases covering preview / apply / svn-mark-resolved / recursive file listing / SVN update `check_only` subdirectory conflict detection
